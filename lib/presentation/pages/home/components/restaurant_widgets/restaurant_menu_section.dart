...
import 'package:foodexpress_mobile/presentation/pages/home/components/food_card_widget.dart';
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text(restaurantMenuState.food.length.toString(), style: AppTextStyles.bodySmall.copyWith(fontSize: 16)),
              ],
            ),
            ...
            restaurantMenuState.food.isEmpty
                ? Center(
                    child: Padding(
                      ...
                      child: Text("Menuda hech narsa yo'q", style: AppTextStyles.bodySmall.copyWith(fontSize: 16)),
                    ),
                  )
                : GridView.builder(
                    shrinkWrap: true,
                      ...
                      return BlocSelector<CartBloc, CartState, int>(
                        ...
                        builder: (context, quantity) {
                          ...
                          return FoodCardWidget(
                            ...
                            onAdd: () async {
                              ...
                              final shouldReplace = await showDialog<bool>(
                                ...
                                builder: (_) => AlertDialog(
                                  ...
                                  actions: [
                                    TextButton(onPressed: () => context.pop(false), child: const Text("Bekor qilish")),
                                    FilledButton(
                            ...
                            onRemove: () {
                              context.read<CartBloc>().add(CartItemQuantityChanged(food.id.toString(), quantity - 1));
                            },
                          );
                        },
                      );
