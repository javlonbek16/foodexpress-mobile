...
import 'package:foodexpress_mobile/presentation/pages/home/components/restaurant_widgets/restaurant_detail_skleton_widget.dart';
      ...
      builder: (context, state) {
        ...
        return Column(
          ...
          children: [
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: restaurant.isOpen ? AppColors.restaurantOpen : AppColors.restaurantClosed,
                    borderRadius: BorderRadius.circular(20),
                  ),
                  child: Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: AppTextStyles.titleSmall.copyWith(
                          ...
                          color: restaurant.isOpen ? AppColors.restaurantOpenText : AppColors.restaurantClosedText,
                        ),
                      ),
                    ],
                  ),
            ...
            Text(restaurant.description, style: TextStyle(color: Colors.grey.shade600, height: 1.5)),
