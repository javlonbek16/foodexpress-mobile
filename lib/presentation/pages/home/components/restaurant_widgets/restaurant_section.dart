...
import 'package:foodexpress_mobile/presentation/pages/home/components/restaurant_widgets/restaurant_card_widget.dart';
import 'package:foodexpress_mobile/presentation/pages/home/components/restaurant_widgets/restaurants_skleton_widget.dart';
          ...
          children: [
            ...
            SizedBox(
              ...
              child: state.restaurants.isEmpty
                  ? const Center(child: Text("Restoranlar topilmadi", style: AppTextStyles.titleMedium))
                  : ListView.separated(
