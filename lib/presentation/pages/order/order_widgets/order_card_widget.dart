...
import 'package:foodexpress_mobile/presentation/pages/order/order_widgets/order_status_widget.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(children: [Icon(Icons.calendar_today_outlined, size: 18), SizedBox(width: 8), Text(formattedDate)]),

          const SizedBox(height: 10),

          Row(
            children: [Icon(Icons.attach_money, size: 18), SizedBox(width: 8), Text(order.totalPrice.formattedPrice)],
          ),
        ],
      ),
    );
