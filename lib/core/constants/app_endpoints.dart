class AppEndpoints {
  ...
  static String menuCategoryApi(String restaurantId) => "/api/restaurants/$restaurantId/menucategory";
  ...
  static String restaurantByCategoryApi(String categoryName) => "/api/category/restaurants/$categoryName";
